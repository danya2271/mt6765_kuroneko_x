...
#ifdef CONFIG_FUCK_MTK_LOG
#define LOGGER_BUFFER_SIZE 4
#define ERROR_BUFFER_COUNT 1
#define FENCE_BUFFER_COUNT 4
#define DEBUG_BUFFER_COUNT 1
#define DUMP_BUFFER_COUNT 1
#define STATUS_BUFFER_COUNT 1
#define DEBUG_BUFFER_SIZE 1
#else
#define LOGGER_BUFFER_SIZE (8 * 1024)
#define ERROR_BUFFER_COUNT 4
#define FENCE_BUFFER_COUNT 10
#define DEBUG_BUFFER_COUNT 8
#define DUMP_BUFFER_COUNT 5
#define STATUS_BUFFER_COUNT 1
