...
#define MET_MODE_TRACE_CMD			(NODUMP)

#define MET_STRBUF_SIZE		256
...
/* No logs patch */
#define NODUMP 1
#define MTAG_CMD_ONESHOT	_IOW(NODUMP)
#define MTAG_CMD_DUMP		_IOW(NODUMP)
#define MTAG_CMD_DUMP_SIZE	_IOWR(NODUMP)
#define MTAG_CMD_DUMP_SAVE	_IOW(NODUMP)
#define MTAG_CMD_DUMP_AGAIN	_IOW(NODUMP)
...
#define met_record_on()	

#define met_record_off()
